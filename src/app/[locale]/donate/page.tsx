          ...
          <div id="sec-online" data-animate className="relative">
            ...
            <div className="relative rounded-3xl border border-border bg-white p-7 shadow-card md:p-9">
              <div className="mb-7 flex items-center gap-3">
                <span className="grid h-11 w-11 place-items-center rounded-2xl bg-gradient-to-br from-destructive to-pink-deep text-white shadow-md shadow-destructive/25">
